...
function App() {
  ...
  return (
    <section className='flex items-center justify-center bg-gradient-to-br from-zinc-950 to-zinc-900 min-h-screen px-4 py-12'>
      ...
      >
        <h1 className='text-2xl sm:text-4xl font-bold mb-10 text-center text-gray-100 tracking-tight'>
          💱 Currency Converter
        </h1>
        ...
        <div className='flex gap-4 mt-2'>
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className='flex-1'>
            <Button
              ...
              className='w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-md hover:shadow-lg'
              disabled={loading}
            >
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className='flex-1'>
            <Button
              onClick={handleReset}
              className='w-full py-3 border-zinc-600 text-zinc-300 hover:bg-zinc-700 hover:text-white font-semibold rounded-xl transition-all duration-300 shadow-md hover:shadow-lg'
              disabled={loading}
            >
              Reset
            </Button>
